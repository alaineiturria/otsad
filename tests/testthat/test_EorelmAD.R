library(otsad)
context("Ensemble based ORELM anomaly detector")

test_that("EorelmAD gives the correct result", {
  ...
  correct.results[c(25,26,320, 488)] <- 1

  expect_equal(as.numeric(result$is.anomaly), correct.results)
  expect_equal(round(result[c(25,26,320, 488), "anomaly.score"], 3), c(0.822, 0.707, 0.942, 0.515))
