#' @function IpPewma
#' @description Incremental Processing Probabilistic-EWMA
...
#' @param last.res last returned result as dataframe
#'
#' @return dataset containing if it's anomaly and upper and lower limits


# Pewma CONTROL CHART
IpPewma <- function(data, alpha0 = 0.2, beta = 0, n.train = 5, l = 3, last.res = NULL) {
