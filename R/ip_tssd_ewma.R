#' @function IpTsSdEwma
#' @description Incremental processing two-stage Shift-Detection based on EWMA
...
IpTsSdEwma <- function(data, n.train, threshold, l = 3, m = 5, to.next.iteration = list(last.res = NULL, to.check = NULL, last.m = NULL)) {
