...
#' \code{IpPewma} function using environment variables. It has been shown that
#' in long data sets it can reduce runtime by up to 50\%. This function allows
#' you to calculate anomalies using PEWMA in an incremental processing mode.
#' This algorithm is probabilistic method of EWMA which dynamically adjusts the
...
#' shifts. See also \code{\link{OcpPewma}} the optimized and faster function of
#' the same.
#'
