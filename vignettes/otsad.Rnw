...
plot(online_norm_value[-1], type = "l",
...
\begin{table}[htbp]
  ...
  \begin{tabular}{llll}
    ...
    \multirow{4}{*}{Online normalization}
     & Dynamic normalization (R6) & DinamycNormalizer & DinamycNormalizer \\
     & Window normalization (R6) & WindowNormalizer & WindowNormalizer \\
     & Adaptive normalization (R6) & AdaptiveNormalizer & AdaptiveNormalizer \\
     & Adaptive normalization2 (R6) & AdaptiveNormalizer2 & AdaptiveNormalizer2 \\ \hline
