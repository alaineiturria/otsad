...
\hlcom{## Generate data}
\hlkwd{set.seed}\hlstd{(}\hlnum{100}\hlstd{)}
\hlstd{normalizer} \hlkwb{<-} \hlstd{DinamycNormalizer}\hlopt{$}\hlkwd{new}\hlstd{()}
\hlstd{online_norm_value} \hlkwb{<-} \hlkwd{sapply}\hlstd{(df}\hlopt{$}\hlstd{value, normalizer}\hlopt{$}\hlstd{normalize)}

\hlkwd{plot}\hlstd{(online_norm_value[}\hlopt{-}\hlnum{1}\hlstd{],} \hlkwc{type} \hlstd{=} \hlstr{"l"}\hlstd{,}
